...
public record RelationalExpression(String operator,IExpression leftOperand, IExpression rightOperand) implements IExpression {
    @Override
    ...
    private boolean isResult(IntegerValue leftVal, IntegerValue rightVal) throws InvalidTypeException, UnknownOperatorException {
